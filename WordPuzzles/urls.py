...
from puzzles.views import HomeView, EditPuzzleView, NewPuzzleView, EditClueView, DeleteClueView, AllPuzzlesView
...
urlpatterns = [
    ...
    path('all_puzzles', AllPuzzlesView.as_view(), name='all_puzzles'),
