...
class PreviewPuzzleTests(SeleniumTestCase):
    ...
    def test_Preview_Puzzle_page_shows_basic_headers_and_widgets(self):
        ...
        self.assert_text_equals("//h2", "Preview Puzzle #" + str(puzzle.id))
        self.assert_exists("//a[text()='DONE']")
        self.assert_exists("//input[@type='checkbox']")
        self.assert_text_equals("//label", "Show answers")
        self.assert_text_equals("//h4/b", str(puzzle))
        self.assert_exists("//h6[text()='Posted by: test_user']")
        self.assert_not_exists("//h6[contains(text, 'Description')]")  # No description
    ...
    def test_Preview_Puzzle_page_with_desc_and_clue(self):
        ...
        self.get('/preview_puzzle/' + str(puzzle.id) + '/')
        self.assert_exists("//h6[text()='Description: Some description']")  # No description
        self.assert_not_exists("//div[text()='No clues exist.']")  # This should NOT exist
