...
const toggle1Id = "toggle-1", jqToggle1Id = "#" + toggle1Id;
const toggle2Id = "toggle-2", jqToggle2Id = "#" + toggle2Id;
...
function setupDOM() {
    ...
    $(jqFixtureId).append($("<input type='radio'>").attr('id', toggle1Id));
    $(jqFixtureId).append($("<input type='radio'>").attr('id', toggle2Id));
